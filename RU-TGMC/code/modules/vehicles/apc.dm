...
var/list/free_modules = list("Medical Modification", "Supply Modification")
...
/obj/effect/multitile_spawner/cm_transport/apc/Initialize()
	. = ..()
...
/obj/effect/multitile_spawner/cm_transport/apc/decrepit/Initialize()
	var/obj/vehicle/multitile/root/cm_transport/apc/R = new(src.loc)
	R.dir = EAST
...
/obj/effect/multitile_spawner/cm_transport/apc/prebuilt/Initialize()
	var/obj/vehicle/multitile/root/cm_transport/apc/R = new(src.loc)
	R.dir = EAST
...
/obj/effect/multitile_spawner/cm_transport/apc/upp/Initialize()
	var/obj/vehicle/multitile/root/cm_transport/apc/R = new(src.loc)
	R.dir = EAST
...
/obj/vehicle/multitile/root/cm_transport/apc/proc/access_camera(var/mob/living/M)
	...
	if(camera_user)
		...
		camera_user = M
		M.reset_perspective(interior_cam)
...
/obj/vehicle/multitile/root/cm_transport/apc/handle_interior_entrance(var/mob/living/carbon/M)
	...
	if(!do_after(M, 20, needhand = FALSE))
...
/obj/vehicle/multitile/root/cm_transport/apc/handle_xeno_entrance(mob/living/carbon/xenomorph/X)
	...
	if(!do_after(X, 20, needhand = FALSE))
